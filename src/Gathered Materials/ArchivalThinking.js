const ArchivalThinking = (props) => {
    ...
    <>
        <div className="container one-hundred-vh pumpkin">
            <div className="container-length one-hundred-vh flex">
                <div className="intro-panel-width flex flex-end">
                ...
                <div className="panel-700 flex column">
                ...
                <div className="panel-1400 flex column">
                    ...
                    <div className="h-fifty flex">
                        <div className="w-sixty">
                            <div className="flex h-one-hundred">
                                <div className="bebe-seattle w-forty-seven stnd-padding">
                                    <div className="flex flex-end">
                        ...
                        <div className="w-forty flex column flex-end al-center double-padding w-one-hundred">
                            <div className="flex flex-end w-one-hundred stnd-padding">
