    ...
    <>
        <div style={{ backgroundColor: background, color: textColor }} className="top-padding essay-padding flex column al-center">
            ...
            <section className="flex column al-center">
                <div>
                <h2 className="black-border-bottom"><b>Presentation 1:</b></h2>
                    <ul>
                        ...
                        <ul>
                            <li className="dashes">A dance archive is built around an absence</li>
                            <li className="dashes">Dissatisfaction with video as the way to represent and archive</li>
                            <ul>
                        ...
                        <ul>
                            <li className="dashes">How are artists involved in creating their archives?</li>
                            <li className="dashes">How do these archives tell their stories?</li>
                            <li className="dashes">How is archiving itself a creative process?</li>
                            <li className="dashes">How can dance and archiving be integrated?</li>
                            <li className="dashes">How do artists engage with their legacy materials?</li>
                        </ul>
                        <li className="bullets">Practical aspect (i.e. getting things to a point where they can be archived</li>
                        <ul>
                            <li className="dashes"><a href="https://www.danceusa.org/archiving-preservation-artists-legacy-toolkit" target="_blank">Artist’s Legacy Toolkit</a>: suite of practical tools and guides and information about archiving</li>
                            <li className="dashes">How can we help independent artists? Support, funding, resources for this work tend to go to biggest, wealthiest companies. Looking to provide solutions that do not assume a great deal of money and time; resources for people at all career stages</li>
                            <li className="dashes">Archive consultants</li>
                        </ul>
                        ...
                        <ul>
                            <li className="dashes">There is a need for a simple, stream-lined, flexible platform and a set of standards to create databases and ways of sharing work</li>
                            <ul>
                        ...
                        <ul>
                            <li className="dashes">Shift from analog to digital = a shift in the way we think about archive and archival needs</li>
                            <li className="dashes">Digital life = constant turnover of platforms = potential for loss and system incompatibility</li>
                        </ul>
                        <li className="bullets">“Archive brought to life”</li>
                        <ul>
                            <li className="dashes">Engaging with an archive can become a part of the creative process and influence new works (David Gordon example)</li>
                            <ul>
                        ...
                        <ul>
                            <li className="dashes">Appetite of audience to access archives + appetite of artists to share their work; two appetites coming together (Eiko and Koma example)</li>         
                        </ul>
                        <li className="bullets">How to bring the body into the archive?</li>
                        <ul>
                            <li className="dashes">Artform that is passed down from body to body, constant shift of material through different bodies (Gene Butler and Our Steps, Our Story)</li>
                            <ul>
                        ...
                        <ul>
                            <li className="dashes">Strategies for old videos? How to transfer them into more modern formats? (Mitchell Rose)</li>
                            <ul>
                                <li className="bullets">Two parts (IS)</li>
                                <ol>
                                    <li className="dashes">Digitization: material is deteriorating and window is closing</li>
                                    <ul>
                                        <li className="bullets">This is a question of funding</li>
                                        <ul>
                                            <li className="dashes">Regranting money, especially for independent artists </li>
                                        </ul>
                                    </ul>
                                    <li className="dashes">Repository: Who steps up to be the repository so that as formats change the safety of files is not compromised</li>
                                    <li className="dashes">Need for field to come together to decide what it wants and needs</li>
                                </ol>
                            </ul>
                            <li className="dashes">Gaps in terms of which artists are archived and which artists are not? (MG)</li>
                            <ul>
