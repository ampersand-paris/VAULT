        ...
        <div style={{ backgroundColor: background, color: textColor }} className="top-padding flex jc-center mobile-column sand-txt">
            <div className="vault-padding mobile-jc-center mobile-flex">
                <div className="relative essay-title-height mobile-width  flex  space-btwn ">
                    ...
                    <div className="flex column flex-end">
                        <a href="/jane-jerardi-bio" class="cursor no-underline" style={{ color: textColor}}><h2 className="subtitle essay-author">Jane Jerardi</h2></a>
                    </div>
                </div>
            </div>
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <p>I often consider what and how I’m sharing from a work in-process and what documentation I share from a live work. <a id="excerpt-one"></a>I sometimes feel the desire to be selective about what I share with the world. Sometimes the process of making a work—the visual notes that might appear as Instagram posts, for example—becomes almost another piece in and of itself.</p>
