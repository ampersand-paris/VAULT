        ...
        <div style={{ backgroundColor: background, color: textColor }} className="essay-padding top-padding flex jc-center mobile-column">
            ...
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <p>It’s incredible to be able to see works that you wouldn’t otherwise, whether through Vimeo sharing of private links from friends and collaborators or channels like OtB.tv. At the same time, <a id="excerpt-one"></a>there is often anxiety around documentation: will it be “good,” will it accurately represent, where will it live, how to preserve it … all of these little concerns that add up. And I always think of something Adrienne Trustcott said to me for <a href="https://www.nytimes.com/2010/01/24/arts/dance/24boards.html" target="_blank">this NYT article</a>:</p>
                    ...
                    <p><a id="excerpt-two"></a>I try to assume nothing about “audience.” It’s an abstraction I’ve never found particularly helpful.</p>
