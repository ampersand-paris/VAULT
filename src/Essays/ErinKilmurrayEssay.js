            ...
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <ul>
                        ...
                        <li className="bullets"><a id="excerpt-one"></a>My own dance-making has bloomed to me over time, due to the wide availability of artists’ work beyond my own city limits. Having this access has been deeply encouraging, most especially in this moment of my growth and making when I have felt as though my work has no place in the greater Chicago dance scenes. While a fairly adolescent feeling, it has allowed me to feel like less of an outsider.</li>
