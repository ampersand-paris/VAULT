        ...
        <div style={{ backgroundColor: background, color: textColor }} className="essay-padding top-padding flex jc-center mobile-column">
            <div className="vault-padding mobile-jc-center mobile-flex">
                <div className="relative essay-title-height mobile-width  flex  space-btwn ">
                    ...
                    <a href="/erin-kilmurray-bio" class="cursor no-underline" style={{ color: textColor}}><h2 className="subtitle essay-author">Erin Kilmurray</h2></a>
                    </div>
                </div>
            </div>
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <ul>
                        ...
                        <li className="bullets"><a id="excerpt-two"></a>My own dance-making has bloomed to me over time, due to the wide availability of artists’ work beyond my own city limits. Having this access has been deeply encouraging, most especially in this moment of my growth and making when I have felt as though my work has no place in the greater Chicago dance scenes. While a fairly adolescent feeling, it has allowed me to feel like less of an outsider.</li>
