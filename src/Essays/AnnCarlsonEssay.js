        ...
        <div style={{ backgroundColor: background, color: textColor }} className="essay-padding top-padding flex jc-center mobile-column">
            ...
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <p>My process of making work has not been deeply impacted by the presence of the digital medium. I have been impacted by making work inside the digital media discipline, however. I have had to be encouraged to participate, use and work with the digital representations of my work for marketing purposes. <a id="excerpt-one"></a>I admit I have on-going resentment about the conflation of live performance and the mediated copy.</p>
