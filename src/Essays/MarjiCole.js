...
const MarjiColeEssay = (props) => {
    ...
    return (
    <>
        <div className="top-padding flex jc-center preserved-lemon">
            <div className="vault-padding">
                <div className="relative flex space-btwn essay-title-height">
                    <div>
            ...
            <section className="flex column al-center preserved-lemon">
                ...
                <p>Create a valid space to move away from product driven work. Who has to change in order for this to happen. Potential audience, funders and the artists themselves? Recalibrate a system of values and successes…</p>
