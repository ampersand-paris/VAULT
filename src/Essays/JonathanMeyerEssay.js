        ...
        <div className="top-padding flex jc-center mobile-column preserved-lemon ">
            <div className="vault-padding mobile-jc-center mobile-flex">
                <div className="relative essay-title-height mobile-width  flex  space-btwn ">
                    ...
                    <div className="flex column flex-end">
                        <h2 className="subtitle essay-author">Jonathan Meyer</h2>
                    </div>
                </div>
            </div>
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <p>Germane to this topic, I would say that the work fails when it’s not live. A bit of well placed video as a marketing tool might catch a potential audience member’s attention, but otherwise I feel that digital/virtual is a tool for my relationship with funders, not audience.</p>
