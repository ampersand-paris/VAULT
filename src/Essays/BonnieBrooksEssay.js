        ...
        <div style={{ backgroundColor: background, color: textColor }} className="top-padding flex jc-center mobile-column sand-txt">
            <div className="vault-padding mobile-jc-center mobile-flex">
                <div className="relative essay-title-height mobile-width  flex space-btwn ">
                    ...
                    <div className="flex column flex-end">
                        <a href="/bonnie-brooks-bio" class="cursor no-underline" style={{ color: textColor}}><h2 className="subtitle essay-author">Bonnie Brooks</h2></a>
                    </div>
                </div>
            </div>
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <p>We know what conventional practice has assumed since the advent of affordable videotape recorders and digital resources: record the process, record the dance, save for the future, make available under controlled (or not controlled) platforms. <a id="excerpt-one"></a>Over time these platforms have become largely digital, though assets of various kinds continue to be accepted, maintained and archived in libraries and related public and private collections.</p>
                    ...
                    <p>In the 2000s, when YouTube, Vimeo etc became sustainable archival platforms, documentation of dance practice and production took another turn. This widened a general discussion about intellectual property in dance, and public access/use of such content. <a id="excerpt-two"></a>The advent of personal, digital phones opened yet a wider avenue to cost-free recording and documentation.</p>
