        ...
        <div style={{ backgroundColor: background, color: textColor }} className="essay-padding top-padding flex jc-center mobile-column">
            <div className="vault-padding mobile-jc-center mobile-flex">
                <div className="relative essay-title-height mobile-width  flex  space-btwn ">
                    ...
                    <div className="flex column flex-end">
                        <a href="/angie-hauser-bio" class="cursor no-underline" style={{ color: textColor}}><h2 className="subtitle essay-author">Angie Hauser</h2></a>
                    </div>
                </div>
            </div>
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <p>These digital objects include Motion Bank's <a href="http://scores.motionbank.org/two/#/set/sets" target="_blank">TWO</a> and Bebe Miller Company's <a href="https://bebemillercompany.org/projects/dancefort/" target="_blank">Dance Fort</a> ebook, <a href="http://themakingroom.org/" target="_blank">The Making Room</a>, and <a href="https://bebemillercompany.org/projects/in-a-rhythm-e-book/" target="_blank">How Dancing is Built: The Making of In A Rhythm</a> ebook.</p>
