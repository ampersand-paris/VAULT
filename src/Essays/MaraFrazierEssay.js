        ...
        <div style={{ backgroundColor: background, color: textColor }} className="top-padding flex jc-center mobile-column">
            <div className="vault-padding mobile-jc-center mobile-flex">
                <div className="relative essay-title-height mobile-width  flex  space-btwn ">
                    ...
                    <div className="flex column flex-end">
                        <a href="/mara-frazier-bio" class="cursor no-underline" style={{ color: textColor}}><h2 className="subtitle essay-author">Mara Frazier</h2></a>
                    </div>
                </div>
            </div>
            <section className="flex column al-center mobile-padding">
                <div className="essay-width">
                    ...
                    <p><a id="excerpt-one"></a>I assume that audiences have viewed at least a sample of a choreographer’s work before they buy a ticket. I am aware that they have the ability to find endless playlists of dance videos online. So, if they come to a performance that I am a part of, it means that they have intentionally chosen that live experience for a reason. I am not assuming I know what the reason is, but some guesses would be that they are choosing to participate in a community, or that they trust the choreographer, director, or presenter to curate an experience for them better than they can do at home with the internet.</p>
