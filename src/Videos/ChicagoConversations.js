...
const ChicagoConversations = (props) => {

    const location = useLocation()
    let background = 'var(--sand)';
    let startTime = 'https://player.vimeo.com/video/783388128?h=d381464825'
    let textColor = 'black';
            ...
            <div className="flex column al-center mobile-width">
                <div className="video-details-width flex column space-btwn">
                    <div style={{ color: textColor }}>
                        <p className="transcription"><b>Conversations, Meeting #4:</b></p>
...
export default ChicagoConversations;