...
const FailspaceBio = (props) => {
    ...
    return (
    <>
        <div className="essay-padding flex mobile-al-center mobile-column top-padding mint-green">
            <div className="vault-padding mobile-flex mobile-jc-center mobile-width">
                <div className="flex space-btwn essay-title-height">
                    <div>
                        ...
                        <h2 className="subtitle neuzit">FAILSPACE <br></br>Design Services</h2>
                    </div>
            ...
            <section className="flex column al-center no-top-padding mobile-padding">
                    <p className="no-top-padding">This site was designed and developed by Angel Acuña and Ampersand Paris of <a href="www.failspacenyc.com/design-services" target="_blank">FAILSPACE Design Services</a>, a design agency committed to equitable design that serves the aesthetic and branding needs of their clients while investing in a cooperative and artist driven future.</p>
